...
This mechanism has been integrated into Bitcore-Node-REBL which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/REBL-Project/insight-api-rebellious#web-socket-api](https://github.com/REBL-Project/insight-api-rebellious#web-socket-api) 
* API: [https://github.com/REBL-Project/insight-api-rebellious#instantx-transactions](https://github.com/REBL-Project/insight-api-rebellious#instantx-transactions)
...
By default, the Rebellious daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rebellious daemon:
