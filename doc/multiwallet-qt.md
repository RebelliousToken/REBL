...
In order to support loading of multiple wallets in rebellious-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rebellious.cpp.
...
Changes to rebellious.cpp
----------------------
rebellious.cpp is the entry point into rebellious-qt, and as such, will require some minor modifications to provide hooks for
