...
This means one can have an always-on rebelliousd instance running, and another local rebelliousd/rebellious-qt instance which connects to this node and receives blocks from it.
