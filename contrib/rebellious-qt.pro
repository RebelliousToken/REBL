...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/rebellious-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/darksend.cpp \
           src/rebellious-cli.cpp \
           src/rebellious-tx.cpp \
           src/rebellious.cpp \
           src/db.cpp \
           ...
           src/qt/rebellious.cpp \
           src/qt/rebelliousstrings.cpp \
...
RESOURCES += src/qt/rebellious.qrc src/qt/rebellious_locale.qrc

TRANSLATIONS += src/qt/locale/rebellious_bg.ts \
                src/qt/locale/rebellious_de.ts \
                src/qt/locale/rebellious_en.ts \
                src/qt/locale/rebellious_es.ts \
                src/qt/locale/rebellious_fi.ts \
                src/qt/locale/rebellious_fr.ts \
                src/qt/locale/rebellious_it.ts \
                src/qt/locale/rebellious_ja.ts \
                src/qt/locale/rebellious_pl.ts \
                src/qt/locale/rebellious_pt.ts \
                src/qt/locale/rebellious_ru.ts \
                src/qt/locale/rebellious_sk.ts \
                src/qt/locale/rebellious_sv.ts \
                src/qt/locale/rebellious_vi.ts \
                src/qt/locale/rebellious_zh_CN.ts \
                src/qt/locale/rebellious_zh_TW.ts
