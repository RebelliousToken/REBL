Contributing to Rebellious
============================

The Rebellious project operates an open contributor model where anyone is
...
The following applies to code changes to the Rebellious project, and is not to be
confused with overall REBL Network Protocol consensus changes.

Whether a pull request is merged into Rebellious rests with the project merge
...
Patches that change REBL consensus rules are considerably more involved than
...
Where a patch set proposes to change the REBL consensus, it must have been
...
The project leader is the release manager for each Rebellious release.
