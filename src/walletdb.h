...
public:
    ...
    bool WriteRebelliousNodeConfig(std::string sIndex, const CRebelliousNodeConfig& nodeConfig);
    bool ReadRebelliousNodeConfig(std::string sIndex, CRebelliousNodeConfig& nodeConfig);
    bool EraseRebelliousNodeConfig(std::string sIndex);
