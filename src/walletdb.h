...
public:
    ...
    bool WriteRebelliousNodeConfig(std::string sAlias, const CRebelliousNodeConfig& nodeConfig);
    bool ReadRebelliousNodeConfig(std::string sAlias, CRebelliousNodeConfig& nodeConfig);
    bool EraseRebelliousNodeConfig(std::string sAlias);
