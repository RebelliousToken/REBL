...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Rebellious rebellious-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rebellious-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rebellious transaction") + "\n" +
                               "  rebellious-tx [options] -create [commands]   " + _("Create hex-encoded rebellious transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rebellious transaction
