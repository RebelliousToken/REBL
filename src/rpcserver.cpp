...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Rebellious features */
        {"rebellious", "masternode", &masternode, true, true, false},
        //{"rebellious", "masternodelist", &masternodelist, true, true, false},
        //{"rebellious", "mnbudget", &mnbudget, true, true, false},
        //{"rebellious", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"rebellious", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"rebellious", "mnsync", &mnsync, true, true, false},
        {"rebellious", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"rebellious", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use rebelliousd, or the -server option to rebellious-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> rebellious-cli " + methodname + " " + args + "\n";
}
