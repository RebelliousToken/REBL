...
#ifndef REBL_TRADINGDIALOG_H
#define REBL_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfREBLOnTradingTab();
    ...
    void showBalanceOfREBLOnSendTab();
    void showBalanceOfREBLOnBalanceTab();
    ...
    QString BuyREBL(QString OrderType, double Quantity, double Rate);
    QString SellREBL(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"REBL/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"REBL/BTC\"}"));// "{\"gender\":\"male\"}");
