...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Rebellious"),
     ...
     * override -datadir in the rebellious.conf file in the default data directory
     * (to be consistent with rebelliousd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
