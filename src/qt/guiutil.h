...
/** Utility functions used by the REBL Qt UI.
 */
namespace GUIUtil
{
...
// Render REBL addresses in monospace font
...
// Parse "rebellious:" URI into recipient object, return true on successful parsing
