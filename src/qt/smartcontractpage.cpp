                                              ...
                                              filter(0)
{
    ...
    if (fLiteMode) {
        ...
        if (fMasterNode) {
            ...
            if (!fEnableRebellioussend) {
                ui->toggleObfuscation->setText(tr("Start Rebellioussend"));
            } else {
                ui->toggleObfuscation->setText(tr("Stop Rebellioussend"));
            }
...
void SmartContractPage::toggleObfuscation()
{
    ...
    fEnableRebellioussend = !fEnableRebellioussend;
    obfuscationPool.cachedNumBlocks = std::numeric_limits<int>::max();
